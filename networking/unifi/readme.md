# a simple unifi network appliance deploy

This deploys a single instance of https://docs.linuxserver.io/images/docker-unifi-network-application/#migration-from-unifi-controller
...
# how to deploy
  ...
  7. create the mongo db initialization script as outlined in the linuxserver docs linked above.
  8. adjust any other variables to suit your situation
  9. uc deploy the yaml file
