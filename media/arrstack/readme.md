...
# how to deploy
  ...
  8. You will then need to do a bunch of configuration in the apps for your needs to get them playing nice with your downloaders (flexget, nzbget, qbitorrent, etc)
