# a simple forgejo deploy

This deploys a single instance of https://forgejo.org/
...
# how to deploy
  ...
  8. go read the forgejo docs because there is a bit more config to do to get this working nicely. For example your ssh config so you can perform git actions over ssh instead of http if you want to go that route.
