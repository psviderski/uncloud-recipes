# a simple paperlessngx deploy

This deploys a single instance of https://github.com/paperless-ngx/paperless-ngx
...
# how to deploy
  ...
  7. adjust docker-compose.env, especially the secret
